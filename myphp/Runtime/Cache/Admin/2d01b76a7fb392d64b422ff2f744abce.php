...
<head id="Head1">
    ...
    <script type="text/javascript" src="/Public/js/jquery.easyui.js"></script>

    <script type="text/javascript" src='/Public/js/outlook2.js'> </script>
    ...
    <script type="text/javascript">
        ...
        function serverLogin() {
            ...
            $.post('<?php echo U('Admin/Index/modifyPassword');?>',{password:$newpass.val()}, function(msg) {
        ...
        $(function() {
            ...
            $('#loginOut').click(function() {
                $.messager.confirm('系统提示', '您确定要退出本次登录吗?', function(r) {
                    ...
                    if (r) {
                        location.href = '<?php echo U('Admin/Index/login_out');?>';
                    }
                });
...
<div region="north" split="true" border="false" style="overflow: hidden; height: 30px;
        background: url(/Public/images/layout-browser-hd-bg.gif) #7f99be repeat-x center 50%;
        line-height: 20px;color: #fff; font-family: Verdana, 微软雅黑,黑体">
    <span style="float:right; padding-right:20px;" class="head">欢迎 孙立峰 <a href="#" id="editpass">修改密码</a> <a href="#" id="loginOut">安全退出</a></span>
    <span style="padding-left:10px; font-size: 16px; "> </span>
</div>
<div region="south" split="true" style="height: 30px; background: #D2E0F2; ">
    <div class="footer">By slf</div>
</div>
